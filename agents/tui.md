...
| `Inventory` | Tab cycles tabs (Items / Abilities / Stats), Left/Right switches same-tab panes, Up/Down, Confirm, Esc | Confirm on Items places that item; Abilities and Stats are read-only for now. |
