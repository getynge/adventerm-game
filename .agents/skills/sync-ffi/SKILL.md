...
These are restated from [agents/ffi.md](../../../agents/ffi.md) § 7–8 and the FFI [AGENTS.md](../../../adventerm_ffi/AGENTS.md). Stop and ask the user if a change appears to require breaking any of them.
